...
| `buttonContainerStyle` | `StyleProp<ViewStyle>` | `undefined` | Custom styles for the button container. |
| `textStyle` | `StyleProp<TextStyle>` | `undefined` | Custom styles for the button text. |

This documentation ensures that each description accurately reflects the behavior of the corresponding prop. Let me know if you need any adjustments! 🚀
