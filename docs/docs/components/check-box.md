...
| `containerStyle` | object |  | Helps to change the styles of the checkbox main container
| `textStyle` | object |  | Helps to change the text styles of the right text of checkbox
| `checkBoxStyle` | object |  | Helps to change the text styles of the checkbox
