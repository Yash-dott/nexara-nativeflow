...
| `containerStyle` | `StyleProp<ViewStyle>` |  | Applies custom styles to the avatar container. |
| `textStyle` | `StyleProp<TextStyle>` |  | Applies custom styles to the text inside the avatar. |
